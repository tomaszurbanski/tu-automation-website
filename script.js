...
const T = {
  pl: {
    ...
    'typed.words': 'dla przemysłu.|sterowania PLC.|SCADA i HMI.',
    ...
    'sec.about.tag': 'O mnie', 'sec.about.title': 'Tomasz Urbański', 'sec.about.desc': 'Inżynier automatyki z ponad 20-letnim doświadczeniem w przemyśle europejskim',
    'about.s1': 'lat doświadczenia', 'about.s2': 'projekty w Europie', 'about.s3': 'TIA Portal expert',
    'about.p1': 'Ponad 20 lat doświadczenia w automatyce przemysłowej, utrzymaniu ruchu oraz projektowaniu systemów sterowania.',
    'about.p2': 'Specjalizuję się w programowaniu sterowników <strong>PLC&nbsp;Siemens&nbsp;S7&nbsp;/&nbsp;TIA&nbsp;Portal</strong>, systemach <strong>Lenze</strong>, projektowaniu instalacji elektrycznych w <strong>EPLAN</strong> oraz uruchamianiu maszyn i kompletnych linii produkcyjnych. Realizowałem projekty dla klientów w wielu krajach Europy — modernizacje, optymalizacja procesów, zwiększanie niezawodności produkcji.',
    'about.p3': 'Posiadam doświadczenie w integracji napędów przemysłowych, uruchamianiu maszyn oraz rozwiązywaniu złożonych problemów technicznych w środowisku produkcyjnym. Moim celem jest dostarczanie praktycznych i niezawodnych rozwiązań zwiększających <strong>wydajność, bezpieczeństwo</strong> i dostępność maszyn.',
    'about.cta': 'Porozmawiajmy o projekcie', 'about.blog': 'Czytaj blog',
    ...
    'contact.p': 'Opisz mi swój problem lub cel — przygotowuję bezpłatną wstępną ocenę projektu i orientacyjną wycenę w ciągu 48 godzin. Działam z Niemiec, realizując projekty dla klientów przemysłowych w Europie i na rynkach międzynarodowych.',
    'contact.location': 'Deutschland · Europa · Projekty międzynarodowe',
    ...
    'form.service.opt2': 'System SCADA / HMI', 'form.service.opt3': 'Modernizacja / migracja systemu', 'form.service.opt4': 'Sieci przemysłowe',
    ...
    'footer.location': 'Deutschland · Europa · Projekty międzynarodowe',
  ...
  en: {
    ...
    'typed.words': 'for industry.|PLC control.|SCADA & HMI.',
    ...
    'sec.about.tag': 'About me', 'sec.about.title': 'Tomasz Urbański', 'sec.about.desc': 'Automation engineer with 20+ years of experience in European industry',
    'about.s1': 'years experience', 'about.s2': 'projects in Europe', 'about.s3': 'TIA Portal expert',
    'about.p1': 'Over 20 years of experience in industrial automation, maintenance, and control system design.',
    'about.p2': 'I specialize in <strong>Siemens S7&nbsp;/&nbsp;TIA&nbsp;Portal PLC</strong> programming, <strong>Lenze</strong> drive systems, electrical design in <strong>EPLAN</strong>, and commissioning of machines and complete production lines. I have delivered projects for clients across Europe — modernizations, process optimization, and reliability improvements.',
    'about.p3': 'My goal is to deliver practical and reliable solutions that increase <strong>efficiency, safety</strong>, and machine availability.',
    'about.cta': 'Let\'s talk about your project', 'about.blog': 'Read the blog',
    ...
    'contact.p': 'Describe your problem or goal — I provide a free preliminary project assessment and indicative quote within 48 hours. Based in Germany, delivering projects for industrial clients across Europe and international markets.',
    'contact.location': 'Deutschland · Europe · International Projects',
    ...
    'form.service.opt2': 'SCADA / HMI System', 'form.service.opt3': 'System modernization / migration', 'form.service.opt4': 'Industrial networks',
    ...
    'footer.location': 'Deutschland · Europe · International Projects',
  ...
  de: {
    ...
    'typed.words': 'für die Industrie.|SPS-Steuerung.|SCADA & HMI.',
    ...
    'sec.about.tag': 'Über mich', 'sec.about.title': 'Tomasz Urbański', 'sec.about.desc': 'Automatisierungsingenieur mit über 20 Jahren Erfahrung in der europäischen Industrie',
    'about.s1': 'Jahre Erfahrung', 'about.s2': 'Projekte in Europa', 'about.s3': 'TIA Portal Experte',
    'about.p1': 'Über 20 Jahre Erfahrung in industrieller Automatisierung, Instandhaltung und Steuerungssystementwicklung.',
    'about.p2': 'Spezialisiert auf <strong>Siemens S7&nbsp;/&nbsp;TIA&nbsp;Portal SPS</strong>-Programmierung, <strong>Lenze</strong>-Antriebssysteme, elektrisches Design in <strong>EPLAN</strong> sowie Inbetriebnahme von Maschinen und Produktionslinien. Projekte in ganz Europa realisiert.',
    'about.p3': 'Mein Ziel ist es, praktische und zuverlässige Lösungen zu liefern, die <strong>Effizienz, Sicherheit</strong> und Maschinenverfügbarkeit steigern.',
    'about.cta': 'Über ein Projekt sprechen', 'about.blog': 'Blog lesen',
    ...
    'contact.p': 'Schildern Sie mir Ihr Problem oder Ziel — ich erstelle innerhalb von 48 Stunden eine kostenlose Erstbewertung und ein Richtangebot. Standort Deutschland — Projektrealisierung für Industriekunden in Europa und auf internationalen Märkten.',
    'contact.location': 'Deutschland · Europa · Internationale Projekte',
    ...
    'form.service.opt2': 'SCADA / HMI-System', 'form.service.opt3': 'Modernisierung / Migration', 'form.service.opt4': 'Industrienetzwerke',
    ...
    'footer.location': 'Deutschland · Europa · Internationale Projekte',
  ...
  tr: {
    ...
    'typed.words': 'endüstri için.|PLC kontrolü.|SCADA ve HMI.',
    ...
    'sec.about.tag': 'Hakkımda', 'sec.about.title': 'Tomasz Urbański', 'sec.about.desc': 'Avrupa sanayiinde 20+ yıl deneyime sahip otomasyon mühendisi',
    'about.s1': 'yıl deneyim', 'about.s2': 'Avrupa projeleri', 'about.s3': 'TIA Portal uzmanı',
    'about.p1': 'Endüstriyel otomasyon, bakım ve kontrol sistemi tasarımında 20 yılı aşkın deneyim.',
    'about.p2': '<strong>Siemens S7&nbsp;/&nbsp;TIA Portal PLC</strong> programlama, <strong>Lenze</strong> sürücü sistemleri, <strong>EPLAN</strong>\'da elektrik tasarımı ve makinaların ve komple üretim hatlarının devreye alınması konularında uzmanlaşmış. Avrupa genelinde pek çok ülkede modernizasyon, süreç optimizasyonu ve güvenilirlik iyileştirme projeleri gerçekleştirdim.',
    'about.p3': 'Hedefim, <strong>verimlilik, güvenlik</strong> ve makine kullanılabilirliğini artıran pratik ve güvenilir çözümler sunmaktır.',
    'about.cta': 'Proje hakkında konuşalım', 'about.blog': 'Blogu oku',
    'nav.about': 'Hakkımda',
    ...
    'form.service.opt2': 'SCADA / HMI Sistemi', 'form.service.opt3': 'Modernizasyon / Geçiş', 'form.service.opt4': 'Endüstriyel ağlar',
  ...
  ar: {
    ...
    'typed.words': 'للصناعة.|التحكم PLC.|SCADA و HMI.',
    ...
    'sec.about.tag': 'عني', 'sec.about.title': 'Tomasz Urbański', 'sec.about.desc': 'مهندس أتمتة بخبرة أكثر من 20 عامًا في الصناعة الأوروبية',
    'about.s1': 'سنوات خبرة', 'about.s2': 'مشاريع في أوروبا', 'about.s3': 'خبير TIA Portal',
    'about.p1': 'أكثر من 20 عامًا من الخبرة في الأتمتة الصناعية والصيانة وتصميم أنظمة التحكم.',
    'about.p2': 'متخصص في برمجة <strong>Siemens S7&nbsp;/&nbsp;TIA Portal PLC</strong>، وأنظمة محركات <strong>Lenze</strong>، والتصميم الكهربائي في <strong>EPLAN</strong>، وتشغيل الآلات وخطوط الإنتاج الكاملة. نفّذت مشاريع لعملاء في دول أوروبية عديدة — تحديثات وتحسين العمليات وتعزيز الموثوقية.',
    'about.p3': 'هدفي تقديم حلول عملية وموثوقة تزيد <strong>الكفاءة والسلامة</strong> وإتاحة الآلات.',
    'about.cta': 'لنتحدث عن مشروعك', 'about.blog': 'قراءة المدونة',
    'nav.about': 'عني',
    ...
    'form.service.opt2': 'نظام SCADA / HMI', 'form.service.opt3': 'تحديث / ترحيل النظام', 'form.service.opt4': 'الشبكات الصناعية',
